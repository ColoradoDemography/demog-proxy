...
var sslobj={
        port: 443,
        key: 'ssl/docker/privkey24.pem',
        cert: 'ssl/docker/fullchain24.pem',  
        ca: 'ssl/docker/chain24.pem',
        secureOptions: constants.SSL_OP_NO_TLSv1 | constants.SSL_OP_NO_TLSv1_1
};

var redbird = require('redbird')({ port: 443, xfwd: false, ssl: sslobj });
redbird.register('demography.dola.colorado.gov', 'http://website:4020', {ssl: true});
